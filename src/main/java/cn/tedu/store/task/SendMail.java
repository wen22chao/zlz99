...
public class SendMail {
    ...
    public static String myEmailAccount = "827439621@qq.com";
//    public static String myEmailPassword = "zfxzydaoalzzbfia";
    public static String myEmailPassword = "bdcvymwgynpobdci";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "wen22chao@163.com";
...
//    }
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "文超", "UTF-8"));
 
        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        //这里的三个参数，第一个是收件人，第二个是收件人昵称，
        ...
        System.out.println("请输入要发送的邮件正文：");
