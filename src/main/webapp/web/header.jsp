...
<header id="top" class="fixed_nav">
    ...
    <div class="rt">
        <ul class="lf">
            <c:if test="${uid != null }">
            	<li><a href="../user/change_info.do">${username }</a><b>|</b></li>
            </c:if>
            ...
            <li><a href="../cart/list.do" title="我的购物车"><img class="shopcar" src="../images/header/shop_car.png" alt=""/></a><b>|</b></li>
...
<nav id="nav">
    <ul>
        ...
        <li><a href="../main/index.do#computer" >电脑办公</a></li>
        <li><a href="../main/index.do#stationery" >办公文具</a></li>
    </ul>
</nav>
