...
<div id="container" class="clear">
    <form name="" method="POST" action="create.do">
    <!--收货地址-->
    <div class="adress_choice">
        ...
        <select name="address_id">
        	...
        	<option value="${addr.id }">【${addr.tag }】 ${addr.recvName } / ${addr.recvPhone } / ${addr.recvDistrict } ${addr.recvAddress }</option>
        	</c:forEach>
        </select>
            ...
            <ul class="item_detail">
                <li class="p_info">
                	<input type="hidden"
                		name="cart_id"
                		value="${cart.id }" />
                    <b><img width="84" height="84" 
                    	src="${pageContext.request.contextPath }/${cart.goodsImage}"/></b>

                    <b class="product_name lf">${cart.goodsTitle }</b>
                    <br/>
                	<span class="product_color ">颜色：-- --</span>
                </li>
                <li class="p_price">
                    <i>达内专属价</i>
                    <br/>
                ...
                <li class="p_tPrice">￥<span>${cart.goodsPrice * cart.num }.00</span></li>
            </ul>
            </c:forEach>
    ...
    <div id="count_bar">
        ...
        <span class="count_bar_info">已选<b  id="count"> 0 </b>件商品&nbsp;&nbsp;合计(不含运费):<b class="zj"></b> 元</span>
        <span class="go_pay">
        	<input type="submit" 
        		value="确认并付款" />
        </span>
