    ...
    <div class="lf1_bottom">
        <div class="item_cat lf">
            ...
            <div class="item_cat_all">
                ...
                <ul>
                	<c:forEach items="${categories1611 }" var="category">
                    <li><a href="${pageContext.request.contextPath }/goods/list.do?category_id=${category.id }">${category.name }</a></li>
                	</c:forEach>
                </ul>
                <p>${categories161[1].name }</p>
                <ul>
                    <c:forEach items="${categories1612 }" var="category">
                    <li><a href="${pageContext.request.contextPath }/goods/list.do?category_id=${category.id }">${category.name }</a></li>
                	</c:forEach>
                </ul>
                <p>${categories161[2].name }</p>
                <ul>
                    <c:forEach items="${categories1613 }" var="category">
                    <li><a href="${pageContext.request.contextPath }/goods/list.do?category_id=${category.id }">${category.name }</a></li>
                	</c:forEach>
                </ul>
            </div>
