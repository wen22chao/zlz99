...
<div id="container" class="clearfix">
    ...
    <div class="rightsidebar_box rt">
        <div class="rs_header">
            <span class="rs_header_active"><a href="###">我的信息</a></span>
            <span><a href="change_password.do">安全管理</a></span>
        </div>
        ...
        <div class="rs_content">
            ...
            <div class="rs_content_mail">
                ...
                <input name="email" class="ed_email" value="${user.email }"/>
            </div>
            <div>
               	<a href="#" class="button" 
               		id="change_info">保存更改</a>
            </div>
        </div>
        </form>
    </div>
